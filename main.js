...
var client = new discord.Client({ws:{intents:discord.Intents.ALL}, shards:"auto"});
var guild;
var members = [];
...
client.on("ready", async function() {
  ...
  logs.start();
  var pollChannel = guild.channels.cache.find(e => e.name === "sondages");
  ...
  setInterval(() => save.saveFileHistorique(members,__dirname), 30000);
  setInterval(() => logs.historique(members).catch(), 43200000);
